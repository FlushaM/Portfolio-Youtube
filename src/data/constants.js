...
export const education = [
  {
    id: 0,
    img: "", // Cambia esta URL por la imagen que desees
    school: "IANCAP Chile",
    date: "Inicio: 2023 - Actualmente",
    grade: "Promedio: 6.5",
    desc: "Actualmente estoy cursando la carrera de Ingeniería Informática en IANCAP Chile. Durante mis estudios, he adquirido conocimientos en diversas áreas de la informática, incluyendo Estructuras de Datos, Algoritmos, Programación Orientada a Objetos, Sistemas de Gestión de Bases de Datos, Sistemas Operativos y Redes de Computadores, entre otros. Además, me encuentro comprometido con mi formación profesional para alcanzar nuevos logros.",
